...
import com.sta.module.blog.service.user.BlogAuthServiceImpl;
...
public class AppBlogAuthController {
    ...
    public CommonResult<AppAuthLoginRespVO> emailLogin(@Valid @RequestBody AppEmailLoginReqVO reqVO) {
        return success(blogAuthService.emailLogin(reqVO));
    }

    @PostMapping("/email-register")
    @Operation(summary = "邮箱 + 密码 + 验证码注册")
    public CommonResult<Long> emailRegister(@Valid @RequestBody AppEmailRegisterReqVO reqVO) {
        return success(blogAuthService.emailRegister(reqVO));
    }

    @PostMapping("/send-email-code")
    @Operation(summary = "发送邮箱验证码")
    public CommonResult<Boolean> sendEmailCode(@Valid @RequestBody AppSendEmailCodeReqVO reqVO) {
    ...
    public CommonResult<Boolean> resetPassword(@Valid @RequestBody AppResetPasswordReqVO reqVO) {
    ...
    public CommonResult<AppAuthLoginRespVO> socialLogin(@Valid @RequestBody AppSocialLoginReqVO reqVO) {
